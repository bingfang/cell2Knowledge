...
# Read Schema file
df = pd.read_excel('../data/Cell_Phenotype_KG_Schema_v2_simple.xlsm')
print(df.columns)
...
for index, row in df.iterrows():
    ...
    # creat collection from subject and object entities, load subject and object node
